...
const UserProfileScreen: React.FC<UserProfileScreenProps> = ({ stats, onConnectSocial }) => {
  ...
  const handleConnectX = async () => {
      ...
      try {
          const { error } = await supabase.auth.signInWithOAuth({
            provider: 'twitter',
            options: {
                // This tells Supabase to come back to this page
          ...
          // If successful, Supabase redirects the browser to Twitter.
          // The code below this line won't execute immediately because the page unloads.
      } catch (err: any) {
          console.error("OAuth Error:", err);
          setErrorMsg("Connection failed. Are you in Preview mode?");
